...
const RUNTIME_NOTES_BY_ROUTE = new Map([
  ...
  [
    ...
    [
      ...
      'Branch choice labels are chapter titles from PGlite, so their labels are data-driven.',
...
async function generateNavigationDoc() {
  ...
  lines.push(
    ...
    '',
    '- Data-driven controls, such as reader branch choices, use PGlite content for labels.',
